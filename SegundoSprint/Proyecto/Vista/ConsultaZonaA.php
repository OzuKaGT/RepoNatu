...
include_once '../Controlador/BuscarZonaAController.php';
    ...
    <section>
      ...
      <tbody> 
        ...
        <tr>
          ...
          <td style="border:solid darkgrey;"><a href="EditarZonaA.php?id=<?php echo $dato->ID_ZonaAR; ?>" style="color:black;background-color:transparent;text-decoration:underline;text-shadow: #33a24f;"> Editar </a> &nbsp&nbsp
            <a href="../Controlador/EliminarZonaAController.php?id=<?php echo $dato->ID_ZonaAR; ?>" style="color:black;background-color:transparent;text-shadow: #33a24f;"> Eliminar </a></td>
        </tr>
        <?php 
          }
        ?>
